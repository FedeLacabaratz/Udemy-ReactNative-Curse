    ...
    return (
        <Container style={globalStyles.contenedor}>
            <View style={[globalStyles.contenido, { marginTop: 50 }]}>
                ...
                {!completado && tiempo > 0 && (
                    <>
                        <Text style={{ textAlign: 'center', marginTop: 60, marginBottom: 30 }}>Su orden estará lista en: </Text>
                        <Text>
                            <Countdown
                                date={Date.now() + tiempo * 60000} // Realiza los calculos para que tome los minutos
                                renderer={renderer}
                            />
                        </Text>
                    </>
                ...
                {completado && (
                    <>
                        <H1 style={[styles.textoCompletado, { textTransform: 'uppercase' }]}>Orden Lista!</H1>
